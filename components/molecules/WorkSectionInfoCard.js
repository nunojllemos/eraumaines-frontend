...
const WorkSectionInfoCard = ({ slug, src, aspectRatio, category, location, title, description }) => {
    return (
        <article>
            <Link scroll={false} href={`/historias/${slug}`} className='relative block font-light overflow-hidden cursor-pointer group  mb-8 group'>
