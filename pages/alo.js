                ...
                <Grid tablet={800}>
                    <Col tablet={800} mobileCols={2} tabletCols={6}>
                        <div className='sticky top-8'>
                            <ImageContainer src='https://source.unsplash.com/random?hello' aspectRatio='1/1' sizes='50vw' quality={100} />
                        </div>
                    </Col>
                    <Col tablet={800} mobileCols={2} tabletCols={6}>
                        <div className='pb-12 default-text pt-16 768:pt-0'>
                            <span>Contactos</span>
                        </div>
                        ...
                        <div className='pt-16 pb-8 default-text'>
                            <span>Conta-nos a vossa história</span>
                        </div>
                        <form ref={form} onSubmit={sendEmail} className='flex flex-col gap-8'>
                            <div className='grid grid-cols-1 768:flex justify-between gap-8'>
                            ...
                            <div className='mt-64'>
                                <ul className='text-12 opacity-50 flex flex-col gap-2'>
                                    <li>* Campos de preenchimento obrigatórios</li>
                                    <li>** Máximo de 650 caracteres</li>
                                </ul>
                            </div>
                            <div>
                                <button className='default-text flex items-center gap-6'>
                                    <span>Enviar</span>
